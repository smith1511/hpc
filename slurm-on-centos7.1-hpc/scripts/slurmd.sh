...
###############################################################################
# chkconfig:          - 66 33
# description:        SLURMD SLURM worker daemon service
###############################################################################
### BEGIN INIT INFO
# Provides:           slurmd
...
# Default-Start:
# Default-Stop:
# Short-Description:  SLURMD SLURM worker daemon service
# Description:        SLURMD
### END INIT INFO
###############################################################################
...
SERVICE_NAME="SLURMD"
DAEMON_EXEC="$sbindir/slurmd"
#DAEMON_ARGS=
#CONFIG=#_NOT_SUPPORTED_#
PIDFILE="$localstatedir/run/slurmd/slurmd.pid"
#NICE=
USER="root"
GROUP="root"
#SIGHUP_RELOAD=#_NOT_SUPPORTED_#
VARRUNDIR="$localstatedir/run/slurmd"
