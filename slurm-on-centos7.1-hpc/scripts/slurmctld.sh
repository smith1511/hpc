...
###############################################################################
# chkconfig:          - 66 33
# description:        SLURMCTLD SLURM control daemon service
###############################################################################
### BEGIN INIT INFO
# Provides:           slurmctld
...
# Default-Start:
# Default-Stop:
# Short-Description:  SLURMCTLD SLURM control daemon service
...
DAEMON_EXEC="$sbindir/slurmctld"
#DAEMON_ARGS=
#CONFIG=#_NOT_SUPPORTED_#
PIDFILE="$localstatedir/run/slurmctld/slurmctld.pid"
#NICE=
USER="root"
GROUP="root"
#SIGHUP_RELOAD=#_NOT_SUPPORTED_#
VARRUNDIR="$localstatedir/run/slurmctld"
